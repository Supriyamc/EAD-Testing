...
public class AjaxFile extends HttpServlet {
	...
	int fciScore, nirfJournals, indexedPapers, journalPublication, books, 
	booksChapters, disclosuresFiled, 
	patentsGranted, researchGuidanceUg, researchGuidanceMaster, researchGuidancePhd,
	fundedProjects1, 
	fundedProjects2, fundedProjects3, fundedProjects4, 
	consultingProjects1, consultingProjects2, 
	consultingProjects3, consultingProjects4, 
	chairReviewer, fiveDayWorkShop, threeDayWorkShop,
	invitedTalksOutside, eventsOutside, 
	invitedTalksInside, industryRelations, 
	instDeptServicesCoordinator, instDeptServicesOthers, 
	...
	public void calculate() { 
		...
		System.out.println("----------------------------");
		System.out.println(totalScore+" "+bonusScore+" "+finalScore);
	}
	
	public void assignMarks(String desig) {
